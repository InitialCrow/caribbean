    ...
    <section class="agence">
        <section class="qui-sommes-nous col-md-12">
            ...
            <p class=" futuraStd-Light col-md-6">Caribbean Planner est une agence connue et saluée par les partenaires
                ...
                en toute professionnalisme pour ses clients Français mais également étrangers.
        ...
        <section class="col-md-12 equipe">
            ...
            <section class="col-md-8 presentation-christina">
                <p class="futuraStd-Light">Christina est une amoureuse de la Vie et a un sens incroyable de l’optimisme.
                    Grande passionnée par son travail, elle voie le meilleur et le positif de tout ce qu’elle fait.
                    Pas bouddhiste, mais elle aurait pu l’être, pour elle, il y a une solution a tout problème.
                    <br/></p>
                    <p class="futuraStd-Light">Son expérience en tant que Directrice de magasin spécialisé puis de Wedding Planner
                    dans sa propre agence depuis 2010, lui fournissent un réseau et le savoir nécessaire
                    pour veiller à ce que ses clients obtiennent le meilleur et plus encore, ce dont ils ont toujours rêvé.</p>
            </section>
            <section class="col-md-6 equipe-laure margin-top-50">
                <div>
                    <h3 class="didotLTStd-Bold center">Laure</h3>
